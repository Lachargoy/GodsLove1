...
class OperationsServer extends Server
{
    ...
    protected array $tools = [
        ...
        PrepararAltaInsumoTool::class,
        ConfirmarAltaInsumoTool::class,
        PrepararAltaCategoriaTool::class,
        ConfirmarAltaCategoriaTool::class,
        PrepararAltaProductoTool::class,
        ConfirmarAltaProductoTool::class,
        PrepararRecetaProductoTool::class,
        ConfirmarRecetaProductoTool::class,
        PrepararOpcionesProductoTool::class,
        ConfirmarOpcionesProductoTool::class,
    ];
